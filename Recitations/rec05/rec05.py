...
this program is a stamping machine which calculate the amount you owe
...
prints the random generated banner.
...
def numberOfStamps():
    ...
    print()
    stamp06 = int(raw_input("How many 06 cent stamps would you like?"))
    print()
...
def main():
    ...
    printChange(calcAmount, firstName, lastName)
    thankYou()
